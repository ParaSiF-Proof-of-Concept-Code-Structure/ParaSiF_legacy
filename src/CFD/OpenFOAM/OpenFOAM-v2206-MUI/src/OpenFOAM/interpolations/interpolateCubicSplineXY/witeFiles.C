...
{
    defineTypeNameAndDebug(witeFiles, 0);
    addToRunTimeSelectionTable(functionObject, witeFiles, dictionary);
}
}
...
void Foam::functionObjects::witeFiles::setCoordinateSystem
(
...
Foam::volVectorField& Foam::functionObjects::witeFiles::force()
{
...
Foam::volVectorField& Foam::functionObjects::witeFiles::moment()
{
...
void Foam::functionObjects::witeFiles::initialise()
{
    if (initialised_)
    {
        return;
...
void Foam::functionObjects::witeFiles::reset()
{
...
Foam::functionObjects::witeFiles::devRhoReff() const
{
...
Foam::tmp<Foam::volScalarField> Foam::functionObjects::witeFiles::mu() const
{
...
Foam::tmp<Foam::volScalarField> Foam::functionObjects::witeFiles::rho() const
{
    if (rhoName_ == "rhoInf")
    {
...
Foam::scalar Foam::functionObjects::witeFiles::rho(const volScalarField& p) const
{
...
void Foam::functionObjects::witeFiles::addToPatchFields
(
    const label patchi,
...
void Foam::functionObjects::witeFiles::addToInternalField
(
...
void Foam::functionObjects::witeFiles::createIntegratedDataFiles()
{
...
void Foam::functionObjects::witeFiles::writeIntegratedDataFileHeader
(
    const word& header,
    OFstream& os
) const
...
void Foam::functionObjects::witeFiles::writeIntegratedDataFiles()
{
    const auto& coordSys = coordSysPtr_();
...
void Foam::functionObjects::witeFiles::writeIntegratedDataFile
(
    const vector& pres,
    const vector& vis,
...
void Foam::functionObjects::witeFiles::logIntegratedData
(
...
Foam::functionObjects::witeFiles::witeFiles
(
    const word& name,
    const Time& runTime,
    const dictionary& dict,
...
bool Foam::functionObjects::witeFiles::read(const dictionary& dict)
{
...
void Foam::functionObjects::witeFiles::calcForcesMoments()
{
    initialise();
...
Foam::vector Foam::functionObjects::witeFiles::forceEff() const
{
    return sumPatchForcesP_ + sumPatchForcesV_ + sumInternalForces_;
}


Foam::vector Foam::functionObjects::witeFiles::momentEff() const
{
    return sumPatchMomentsP_ + sumPatchMomentsV_ + sumInternalMoments_;
}


bool Foam::functionObjects::witeFiles::execute()
{
    calcForcesMoments();
    ...
    logIntegratedData("witeFiles", localFp, localFv, localFi);
...
bool Foam::functionObjects::witeFiles::write()
{
    if (writeToFile())
    {
