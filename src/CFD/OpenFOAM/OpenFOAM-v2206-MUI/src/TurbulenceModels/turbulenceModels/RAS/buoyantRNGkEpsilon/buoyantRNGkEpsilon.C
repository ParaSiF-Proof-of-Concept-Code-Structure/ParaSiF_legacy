...
void buoyantRNGkEpsilon<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
buoyantRNGkEpsilon<BasicTurbulenceModel>::Gcoef() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> buoyantRNGkEpsilon<BasicTurbulenceModel>::kSource() const
{
    const uniformDimensionedVectorField& g =
        meshObjects::gravity::New(this->mesh_.time());
    ...
    return buoyantRNGkEpsilon<BasicTurbulenceModel>::kSource();
}


template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> buoyantRNGkEpsilon<BasicTurbulenceModel>::epsilonSource() const
{
...
template<class BasicTurbulenceModel>
buoyantRNGkEpsilon<BasicTurbulenceModel>::buoyantRNGkEpsilon
(
...
template<class BasicTurbulenceModel>
bool buoyantRNGkEpsilon<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void buoyantRNGkEpsilon<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
