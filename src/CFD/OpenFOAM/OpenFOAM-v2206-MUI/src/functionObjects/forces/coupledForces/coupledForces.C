...
{
    string interfaceName="mpi://OpenFoam_forces/ifs";
    if (! ifsInit){
    ...
    interface->push( "pForce_x", 0, localFp[0] );
    interface->push( "pForce_y", 0, localFp[1] );
    interface->push( "pForce_z", 0, localFp[2] );

    interface->push( "vForce_x", 0, localFv[0] );
    interface->push( "vForce_y", 0, localFv[1] );
    interface->push( "vForce_z", 0, localFv[2] );

    interface->push( "TotalForce_x", 0, localFp[0]+localFv[0] +localFi[0] );
    interface->push( "TotalForce_y", 0, localFp[1]+localFv[1] +localFi[0] );
    interface->push( "TotalForce_z", 0, localFp[2]+localFv[2] +localFi[0] );

    interface->push( "pMoment_x", 0, localMp[0] );
    interface->push( "pMoment_y", 0, localMp[1] );
    interface->push( "pMoment_z", 0, localMp[2] );

    interface->push( "vMoment_x", 0, localMv[0] );
    interface->push( "vMoment_y", 0, localMv[1] );
    interface->push( "vMoment_z", 0, localMv[2] );

    interface->push( "TotalMoment_x", 0, localMp[0]+localMv[0] +localMi[0] );
    interface->push( "TotalMoment_y", 0, localMp[1]+localMv[1] +localMi[0] );
    interface->push( "TotalMoment_z", 0, localMp[2]+localMv[2] +localMi[0] );
