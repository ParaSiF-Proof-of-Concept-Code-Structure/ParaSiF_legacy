...
set_target_properties(EVPath::EVPath PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libadios2_evpath.so"
  IMPORTED_SONAME_RELEASE "libadios2_evpath.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS EVPath::EVPath )
list(APPEND _IMPORT_CHECK_FILES_FOR_EVPath::EVPath "${_IMPORT_PREFIX}/lib/libadios2_evpath.so" )
