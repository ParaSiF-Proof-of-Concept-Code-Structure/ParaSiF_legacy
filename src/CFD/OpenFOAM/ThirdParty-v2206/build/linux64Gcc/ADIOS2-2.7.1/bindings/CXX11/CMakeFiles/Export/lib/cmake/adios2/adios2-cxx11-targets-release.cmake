...
set_target_properties(adios2::cxx11 PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libadios2_cxx11.so.2.7.1"
  IMPORTED_SONAME_RELEASE "libadios2_cxx11.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS adios2::cxx11 )
list(APPEND _IMPORT_CHECK_FILES_FOR_adios2::cxx11 "${_IMPORT_PREFIX}/lib/libadios2_cxx11.so.2.7.1" )
...
set_target_properties(adios2::cxx11_mpi PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libadios2_cxx11_mpi.so.2.7.1"
  IMPORTED_SONAME_RELEASE "libadios2_cxx11_mpi.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS adios2::cxx11_mpi )
list(APPEND _IMPORT_CHECK_FILES_FOR_adios2::cxx11_mpi "${_IMPORT_PREFIX}/lib/libadios2_cxx11_mpi.so.2.7.1" )
