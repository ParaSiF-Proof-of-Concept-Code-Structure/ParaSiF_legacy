...
set_target_properties(adios2::c PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libadios2_c.so.2.7.1"
  IMPORTED_SONAME_RELEASE "libadios2_c.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS adios2::c )
list(APPEND _IMPORT_CHECK_FILES_FOR_adios2::c "${_IMPORT_PREFIX}/lib/libadios2_c.so.2.7.1" )
...
set_target_properties(adios2::c_mpi PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libadios2_c_mpi.so.2.7.1"
  IMPORTED_SONAME_RELEASE "libadios2_c_mpi.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS adios2::c_mpi )
list(APPEND _IMPORT_CHECK_FILES_FOR_adios2::c_mpi "${_IMPORT_PREFIX}/lib/libadios2_c_mpi.so.2.7.1" )
