...
shift
CMAKE="/usr/bin/cmake"
SOURCE_DIR="/home/omar/WORK/OpenFOAM/OpenFOAM-v2206/ThirdParty-v2206/sources/adios/ADIOS2-2.7.1/cmake/install/post/adios2-config-dummy"
BUILD_DIR=$(mktemp -d)
pushd ${BUILD_DIR}
...
EXTRA_CMAKE_ARGS="${EXTRA_CMAKE_ARGS} -Dadios2_DIR=${PREFIX}/lib/cmake/adios2"
if [ -n "" ]
then
...
cat \
  "/home/omar/WORK/OpenFOAM/OpenFOAM-v2206/ThirdParty-v2206/build/linux64Gcc/ADIOS2-2.7.1/cmake/install/post/adios2-config.pre.sh" \
  adios2.flags \
  "/home/omar/WORK/OpenFOAM/OpenFOAM-v2206/ThirdParty-v2206/build/linux64Gcc/ADIOS2-2.7.1/cmake/install/post/adios2-config.post.sh" > "${BINDIR}/adios2-config"
